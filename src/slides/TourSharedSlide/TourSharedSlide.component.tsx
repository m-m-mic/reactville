        ...
        <div className="foreground-wrapper">
          <div className="slide-explanation">
            ...
            <div className="text-body">
              ...
              One last stop: <b>Shared Street</b> and add one more thing to our current structure. If you ever need to add
              something to your project which doesn't neatly fit into your current project folders, it's best to create a new{" "}
